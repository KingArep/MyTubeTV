...
(function () {
  ...
  function addMenuButton() {
    ...
    if (parent.querySelector('button[data-mytubetv="menu"]')) return; // already exists
    ...
    // Create the MyTubeTV Menu button
    const menuButton = document.createElement("button");
    menuButton.setAttribute("data-mytubetv", "menu");
  ...
  const observer = new MutationObserver((mutations) => {
    ...
    if (
      searchBar &&
      !searchBar.parentNode.querySelector('[data-mytubetv="menu"]')
    ) {
...
(function () {
  ...
  // Patch resolveCommand to be able to change MyTubeTv settings
      ...
      if (
        ...
        window._yttv[key].instance.resolveCommand = function (cmd, _) {
          if (cmd.setClientSettingEndpoint) {
            // Command to change client settings. Use MyTubeTv configuration to change settings.
